...
public class JwtHelper {
     ...
     * @Modified By:
     */
    public static String generateJWT(String userId, String userName, String roles) {
        //签名算法，选择SHA-256
    ...
    public static Map<String, String> validateLogin(String jsonWebToken) {
        ...
        if (claims != null) {
            ...
            //客户名称
            retMap.put("userName", (String) claims.get("userName"));
            //客户端浏览器信息
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(4000);
        System.out.println(parseJWT(jsonWebKey));
//        System.out.println(jsonWebKey);
